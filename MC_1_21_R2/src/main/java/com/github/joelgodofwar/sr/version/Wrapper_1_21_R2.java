...
public class Wrapper_1_21_R2 implements VersionWrapper {
	...
	private static  @Nullable Pair<BlockPos, Holder<Structure>> locateStructure(CraftWorld craftWorld, Location origin, String key, int i, boolean flag, boolean debug) {
        ...
        Registry<Structure> registry = worldServer.registryAccess().lookupOrThrow(Registries.STRUCTURE);
        ...
        Holder<Structure> resourceKeyHolder = registry.get(resourceKey).get();
